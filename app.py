...
label = tk.Label(root, text = "Scrape job Postings", bg = '#f2fcbd', font = fnt.Font(size = 20))
...
entry = tk.Entry(frame, bg = '#fcffeb', font = fnt.Font(size = 20))
entry.place(relx = 0.025, rely = 0.05, relwidth=0.65, relheight=0.4)

entry2 = tk.Entry(frame, bg = '#fcffeb', font = fnt.Font(size = 20))
entry2.place(relx = 0.025, rely = 0.55, relwidth= 0.65, relheight= 0.4)

button = tk.Button(frame, text = "Find Jobs", fg ='#3bb1cc', font = fnt.Font(size = 22))
...
lower_label = tk.Label(lower_frame, bg = '#fcffeb')
